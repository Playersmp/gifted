...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~n6JQVR6Y#VvkVRVBxwgbP86hjltQwqNAVMtCxX7b7M2_MVFL6T5M",
  ...
  AUTO_READ_MESSAGES: process.env.AUTO_READ_MESSAGES !== undefined ? process.env.AUTO_READ_MESSAGES === 'falsw' : false,
  AUTO_TYPING: process.env.AUTO_TYPING !== undefined ? process.env.AUTO_TYPING === 'false' : false,
  AUTO_RECORDING: process.env.AUTO_RECORDING !== undefined ? process.env.AUTO_RECORDING === 'falsw' : false,
  ...
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "18768375254,18764179817",
